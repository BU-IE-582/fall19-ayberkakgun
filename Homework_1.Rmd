...
I use booking data to find games, where happened a red card in the first 15 minutes. Then  I combine it with the games where an extra time goal affected the score. Be careful an extra score that didn't change the result shouldn't be removed. Remaining matches are the "clean matches":
